...
// ── 领域数据访问拆分（part + extension）──────────────────────────────
// 各领域的 DAO 方法逐步拆到独立 part 文件（extension on LocalStorageRepository），
// 调用方无需改动。part 与主文件同库，可访问 _ensureDb() 等私有成员。
part 'local_storage_repository.story.dart';
part 'local_storage_repository.letter.dart';
part 'local_storage_repository.shop.dart';
part 'local_storage_repository.pure_ai.dart';
...
class LocalStorageRepository {
  ...
  // letter 相关方法已拆分至 local_storage_repository.letter.dart
  ...
  // 故事书相关方法（Story Books / Segments / Scenes / Saves）已拆分至
  // local_storage_repository.story.dart（extension StorageStoryDao）。

  // shop 相关方法已拆分至 local_storage_repository.shop.dart

  // pure_ai 相关方法已拆分至 local_storage_repository.pure_ai.dart

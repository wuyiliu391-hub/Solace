...
const VERSION_DATA = {
  ...
  downloadUrl: 'https://solace-auth-v2.pages.dev/api/v1/download?v=17.8.0',
  changelog: [
    '情绪与内心状态进入持续角色状态，下一轮对话会承接本轮关系变化',
    '新增角色承诺与共同经历：记住近期事项、自然跟进并记录结果',
    '新增信任、边界、未修复矛盾和最近重要经历的关系上下文',
    '主动消息新增用户开关、静默时段、冷却、每日上限与空间保护',
    '内置作者角色人格升级，角色资料与互动设置锁定',
    '数据库升级至 v70，新增角色承诺与关系上下文持久化',
  ],
  forceUpdate: false,
};

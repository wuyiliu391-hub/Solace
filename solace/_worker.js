...
const VERSION_DATA = {
  ...
  downloadUrl: 'https://solace-auth-v2.pages.dev/api/v1/download?v=17.9.0',
  changelog: [
    '强化 Operit 设备 Agent：统一意图识别、确定性路由、工具规划、权限控制和真实执行反馈',
    '新增电量、通知、进程、应用与工作区等设备能力，工具失败时返回真实原因',
    '官网全面升级 Operit Agent 说明：展示设备工具、代码工作区、权限闸门和角色化结果链路',
    '增强角色化工具反馈，同时保留剧情、关系和人设上下文',
    '单聊状态栏支持每轮实时情绪 emoji，并可点击放大查看完整内心状态',
    '区分隐藏聊天与隐藏联系人，分别提供独立恢复入口',
    '清理废弃的虚拟电话、旧 TTS、音色克隆和录音转写遗留链路',
    '收敛废弃的 Live2D、音乐陪伴、宠物和故事模块',
    '补强本地数据访问、角色关系、承诺、主动互动和工具任务测试',
  ],
  forceUpdate: false,
};

...
const VERSION_DATA = {
  latestVersion: '17.7.0',
  buildNumber: 290,
  minSdk: 23,
  releaseDate: '2026-08-04',
  downloadUrl: 'https://solace-auth-v2.pages.dev/api/v1/download?v=17.7.0',
  changelog: [
    '旧版本数据库自动检测并补齐缺失表、缺失字段，避免升级后打开报错',
    '修复旧版群聊表字段约束导致创建群聊失败的问题',
    '群聊相关表启动时自动校验：会话、消息、分支、摘要和公共事件记忆表全部补齐',
    '群聊自动回复、按角色接话间隔、成员回复和群聊记忆链路修复',
    '修复小说模式段落标点、自定义状态、角色手机、永久记忆和书签跳转',
    '角色手机继承用户壁纸主题，Android 启动页支持深浅色适配',
    '官网 Bauhaus 主题改版，版本和更新服务同步升级',
  ],
  forceUpdate: false,
};

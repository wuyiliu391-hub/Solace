...
const VERSION_DATA = {
  ...
  downloadUrl: 'https://solace-auth-v2.pages.dev/api/v1/download?v=18.0.0',
  changelog: [
    '新增番外小剧场（平行会话层）：主线与记忆完全隔离，退出即原样切回主线',
    '发现页新增多个高趣味角色，支持分类分组与新上架角标',
    '朋友圈闭环：角色记得发过/评论过/看到过的动态并在聊天中自然承接，支持「不让谁看」',
    '新增角色主动技能：关怀、亲密互动、故事推进、话题发起',
    '修复单聊加载更多崩溃、重新生成取错上下文、hasMore 边界等逻辑 bug',
    '根治 AI 拒绝/上下文污染：历史、记忆、锚点、群聊总结全线过滤，换模型不再被旧拒绝锁死',
    '备用模型沿用角色人设、流式首字超时 30s→60s',
    '数据库孤儿数据治理：删除级联自包含，首次启动自动清理历史孤儿数据',
  ],
  forceUpdate: false,
};
